...
from inference.models.generator.audio_encoder import AudioEnocoder
from inference.models.generator.id_encoder import IdEncoder
from inference.models.generator.id_decoder import IdDecoder

from inference.models.utils import squeeze_batch_frames
...
class Generator(nn.Module):
    ...
    def forward(self,audio_frames,ref_frames):
        ...
        encoded = torch.cat([encoded_id,encoded_audio],dim=1)#along channel dimension
