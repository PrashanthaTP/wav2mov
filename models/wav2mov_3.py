...
class Wav2MovBW(TemplateModel):
    ...
    def set_condition(self, still_image,num_frames):
    ...
    def optimize_sequence(self):
        ...
        losses = {}
        NUM_FRAMES = 20
        randpos = random.randint(0,self.real_frames.shape[2]-NUM_FRAMES)
        ...
        #     break
        self.real_frames = self.real_frames[..., randpos:randpos+NUM_FRAMES, :, :]
